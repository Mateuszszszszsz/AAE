...
trueLabels = np.concatenate([[0] * 1000, [1] * 1000, [2] * 1000])
...
# Original data
ax_scatter[0][0].set_title("Original clusters")
ax_scatter[0][0].scatter(x_mixed, y_mixed, c=trueLabels, edgecolors="black")
...
ax_scatter[0][1].set_title("K-Means clustering")
ax_scatter[0][1].scatter(x_mixed, y_mixed, c=kmeans.labels_, edgecolors="black")
...
ax_scatter[0][2].set_title("Fuzzy C-Means clustering")
ax_scatter[0][2].scatter(x_mixed, y_mixed, c=cmeans_labels, cmap="viridis", edgecolors="black")
...
ax_scatter[1][0].set_title("Spectral clustering")
ax_scatter[1][0].scatter(x_mixed, y_mixed, c=spectral_clustering.labels_, edgecolors="black")
...
ax_scatter[1][1].set_title("DBSCAN clustering")
ax_scatter[1][1].scatter(x_mixed, y_mixed, c=dbscan.labels_, edgecolors="black")
...
ax_scatter[1][2].set_title("GMM clustering")
ax_scatter[1][2].scatter(x_mixed, y_mixed, c=gmm.predict(mixed), edgecolors="black")
